package salesconverter.manage.campign;
...
import salesconverter.mongo.CampaignSheduleMongoDAO;

@Component(immediate = true, metatype = false)
@Service(value = javax.servlet.Servlet.class)
@Properties({ @Property(name = "service.description", value = "Save product Servlet"),
		@Property(name = "service.vendor", value = "VISL Company"),
		@Property(name = "sling.servlet.paths", value = { "/servlet/service/salescampaignactivator" }),
		@Property(name = "sling.servlet.resourceTypes", value = "sling/servlet/default"),
		@Property(name = "sling.servlet.extensions", value = { "hotproducts", "cat", "latestproducts", "brief",
				"prodlist", "catalog", "viewcart", "productslist", "addcart", "createproduct", "checkmodelno",
				"productEdit" }) })
@SuppressWarnings("serial")
public class CampaignActivatorSales extends SlingAllMethodsServlet {
		 ...
		 if (request.getRequestPathInfo().getExtension().equals("activate_draft_list")) {
			...
			try {
							...
							String funnelName = funnelNode.getName();// currentcampaign
								 ...
								 if(funnelNode.hasNodes()){
									   ...
									   while (campaignNodesitr.hasNext()) {
										   ...
										   String subFunnelNodeName = subFunnelNode.getName();
										   out.println("subFunnelNodeName : "+subFunnelNodeName);
										   LogByFileWriter.logger_info("CampaignActivatorSales : " + "subFunnelNodeName : "+subFunnelNodeName);
										   if(subFunnelNode.hasNode("List")){
												Node ListNode=subFunnelNode.getNode("List");
															    ...
															    if(ActiveListChildNode.hasNode("Campaign")){
															    	...
															    	NodeIterator ActiveListChildCampaignNodeItr = ActiveListChildCampaignNode.getNodes();
																	   while (ActiveListChildCampaignNodeItr.hasNext()) {
																		    ...
																		    LogByFileWriter.logger_info("CampaignActivatorSales : " + "Current_Date : " + sdf1.format(date1)+"   Campaign_Date : " + sdf1.format(date2));
																		    if (date1.compareTo(date2) > 0) {
																		        out.println("Date1 is after Date2");
																		        LogByFileWriter.logger_info("CampaignActivatorSales : " + "Date1 is after Date2");
																		    } else if (date1.compareTo(date2) < 0) {
																		        out.println("Date1 is before Date2");
																		        LogByFileWriter.logger_info("CampaignActivatorSales : " + "Date1 is before Date2");
																		    } else if (date1.compareTo(date2) == 0) {
				...
				try {
					...
					LogByFileWriter.logger_info("CampaignActivatorSales : Error : " + errordatajson);
			...
			LogByFileWriter.logger_info("CampaignActivatorSales Called!");
															    ...
															    if(ActiveListChildNode.hasNode("Campaign")){
															    	...
															    	NodeIterator ActiveListChildCampaignNodeItr = ActiveListChildCampaignNode.getNodes();
																	   while (ActiveListChildCampaignNodeItr.hasNext()) {
																			...
																			Active_List_Id=ActiveListChildNode.getName();
																			out.println("ActiveListChildCampaignChildNode Name : "+ActiveListChildCampaignChildNode.getName());
																			LogByFileWriter.logger_info("CampaignActivatorSales : " + "ActiveListChildCampaignChildNode Name : "+ActiveListChildCampaignChildNode.getName());
																			out.println("Active_List_Id Name : "+Active_List_Id);
																			LogByFileWriter.logger_info("CampaignActivatorSales : " + "Active_List_Id Name : "+Active_List_Id);
																		    ...
																		    if (date1.compareTo(date2) > 0) {
																		    	...
																		    	LogByFileWriter.logger_info("CampaignActivatorSales : " + "Date1 is equal to Date2");
																		        ...
																		        LogByFileWriter.logger_info("CampaignActivatorSales : " + "campaignName : "+ActiveListChildCampaignChildNode.getName());
																		        out.println("current_campaign_status : "+campaign_status);
																		        LogByFileWriter.logger_info("CampaignActivatorSales : " + "current_campaign_status : "+campaign_status);
																		    	if(!campaign_status.equals("sent")){
																		    		...
																		    		out.println("===========================Active==============================");
																		    		LogByFileWriter.logger_info("CampaignActivatorSales : " + "===========================Active==============================");
																		    		LogByFileWriter.logger_info("CampaignActivatorSales : " + "Active Campaign : "+ActiveListChildCampaignChildNode.getName());
																		    		LogByFileWriter.logger_info("CampaignActivatorSales : " + "Active Campaign_Id : "+Campaign_Id);
																		    		LogByFileWriter.logger_info("CampaignActivatorSales : " + "Active Active_List_Id : "+Active_List_Id);
																		    		LogByFileWriter.logger_info("CampaignActivatorSales : " + "===========================Active==============================");
																		    		...
																		    		LogByFileWriter.logger_info("CampaignActivatorSales : " + "campaign_list_delete_response : "+campaign_list_delete_response);
																		    		...
																		    		LogByFileWriter.logger_info("CampaignActivatorSales : " + "campaign_list_add_response : "+campaign_list_add_response);
																					...
																					JSONObject response_data_json_obj=(JSONObject) new JSONObject(campaigngetbyid_url_response.replace("<pre>", "")).get("data");
																					  ...
																					  if(status.equals("sent") || status.equals("submitted")){
																						  ...
																						  LogByFileWriter.logger_info("CampaignActivatorSales : " + "No need to Anything : "+status);
																						  if(status.equals("sent")){
																							  ...
																							  LogByFileWriter.logger_info("CampaignActivatorSales : " + "status_response reque: "+status_response);
																						  }
																					  }else{
																						  
																						  System.out.println("Do your stuff here "+status);
																						  LogByFileWriter.logger_info("CampaignActivatorSales : " + "Do your stuff here "+status);
																							...
																							LogByFileWriter.logger_info("CampaignActivatorSales : " + "campaignresponse : "+campaignlistresponse);
																							...
																							if(listSubscribersCount(Active_List_Id,id,response)>0){
																							   ...
																							   LogByFileWriter.logger_info("CampaignActivatorSales : " + "status_response : "+status_response);
																							}else{
																								out.println("No Subscribers Found For List Id : "+Active_List_Id);
																								LogByFileWriter.logger_info("CampaignActivatorSales : " + "status_response : "+"No Subscribers Found For List Id : "+Active_List_Id);
																							}
																					...
																					*/
																		    		...
																		    		LogByFileWriter.logger_info("CampaignActivatorSales : " + "Current Campaign Status is Not equal to Sent");
																		    	}
																		    	
																		        
																		    } else {
																		        out.println("How to get here?");
																		        LogByFileWriter.logger_info("CampaignActivatorSales : " + "How to get here?");
																		    }
						...
						while (funnelitr.hasNext()) {
							...
							if(catogoryFilter.equals("single")){
								if(funnelNode.hasNode(campaignCatogory)){
									...
									LogByFileWriter.logger_info("CampaignActivatorSales : " + "subFunnelNode Name : "+subFunnelNode.getName());
									if(subFunnelNode.hasNode("List")){
										Node ListNode=subFunnelNode.getNode("List");
										if(ListNode.hasNode("ActiveList")){
											Node ActiveListNode=ListNode.getNode("ActiveList");
