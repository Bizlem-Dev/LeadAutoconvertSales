package salesconverter.doctiger;
...
public class LogByFileWriter {
	...
	public static void logger_info_MultipleMails(String data) {
		String path="/home/ubuntu/leadAutoConvertRuleJson/logs/AutoLeadConverter/salesConverterMultiplecateg.txt";
		OutputStream os = null;
	    SimpleDateFormat sdf156 = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
	  	data=sdf156.format(new Date())+" INFO : "+data+"\n";
