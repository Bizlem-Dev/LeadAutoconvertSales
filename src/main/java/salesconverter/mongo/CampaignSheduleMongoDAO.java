	...
	public void activateCampaign(String Campaign_Id, String list_id, String list_id_delete, String Campaign_Date,
		...
		try {
			...
			if (date1.compareTo(date2) == 0) {
				...
				LogByFileWriter
						.logger_info("CampaignSheduleMongoDAO: " + "CampaignActivatorSales : " + "Date1 is equal to Date2");

				System.out.println("current_campaign_status : " + campaign_status);
				LogByFileWriter.logger_info("CampaignSheduleMongoDAO: " + "CampaignActivatorSales : "
				...
				if (!campaign_status.equals("sent")) {
					...
					if (status.equals("sent") || status.equals("submitted")) {
						...
						LogByFileWriter.logger_info(
								"CampaignSheduleMongoDAO: " + "CampaignActivatorSales : " + "Do your stuff here " + status);
				...
				LogByFileWriter
						.logger_info("CampaignSheduleMongoDAO: " + "CampaignActivatorSales : " + "Date1 is after Date2");
			} else if (date1.compareTo(date2) < 0) {
				System.out.println("Date1 is before Date2");
				LogByFileWriter
						.logger_info("CampaignSheduleMongoDAO: " + "CampaignActivatorSales : " + "Date1 is before Date2");
			}
		} catch (Exception ex) {
